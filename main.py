...
def apply_theme(app: QApplication, is_dark: bool):
    ...
    if is_dark:
        ...
        app.setStyleSheet("""
            ...
            QLabel{color:#ffffff;}
            QPushButton{background-color:#3a3a3a;color:#ffffff;border:1px solid #555;border-radius:4px;padding:4px 10px;}
            ...
            QListWidget{background-color:#1e1e1e;color:#ffffff;border:1px solid #3a3a3a;border-radius:4px;}
            ...
            QScrollBar:horizontal{background-color:#2d2d2d;height:12px;border-radius:6px;}
            ...
            QComboBox{background-color:#3a3a3a;color:#fff;border:1px solid #555;border-radius:4px;padding:2px 8px;}
            QComboBox:hover{background-color:#4a4a4a;}
            QComboBox::drop-down{border:none;width:20px;}
            QComboBox QAbstractItemView{background-color:#3a3a3a;color:#fff;selection-background-color:#2196F3;}
            QLineEdit{background-color:#2a2a2a;color:#fff;border:1px solid #555;border-radius:4px;padding:4px 8px;}
            QLineEdit:focus{border-color:#2196F3;}
            QMenu{background-color:#2d2d2d;color:#fff;border:1px solid #555;}
            QMenu::item:selected{background-color:#2196F3;}
            QMenuBar{background-color:#2d2d2d;color:#fff;}
            QMenuBar::item:selected{background-color:#3a3a3a;}
            QSlider::groove:horizontal{height:6px;background:#3a3a3a;border-radius:3px;}
            QSlider::handle:horizontal{background:#2196F3;width:16px;height:16px;margin:-5px 0;border-radius:8px;}
            QSlider::sub-page:horizontal{background:#2196F3;border-radius:3px;}
            QDialog{background-color:#2d2d2d;}
            QGroupBox{color:#fff;border:1px solid #555;border-radius:4px;margin-top:10px;padding-top:10px;}
        ...
        app.setStyleSheet("""
            ...
            QLabel{color:#000;}
            QPushButton{background-color:#e0e0e0;color:#000;border:1px solid #ccc;border-radius:4px;padding:4px 10px;}
            QPushButton:hover{background-color:#d0d0d0;}
            QPushButton:pressed{background-color:#c0c0c0;}
            QPushButton:disabled{color:#999;background-color:#e8e8e8;}
            QPushButton:checked{background-color:#2196F3;border-color:#2196F3;color:white;}
            QListWidget{background-color:#fff;color:#000;border:1px solid #ccc;border-radius:4px;}
            QListWidget::item{padding:3px 5px;border-radius:2px;}
            QListWidget::item:selected{background-color:#2196F3;color:white;}
            ...
            QScrollBar::handle:vertical:hover{background-color:#aaa;}
            QScrollBar::add-line:vertical,QScrollBar::sub-line:vertical{height:0px;}
            QScrollBar:horizontal{background-color:#f0f0f0;height:12px;border-radius:6px;}
            QScrollBar::handle:horizontal{background-color:#ccc;border-radius:6px;min-width:20px;}
            QScrollBar::handle:horizontal:hover{background-color:#aaa;}
            QScrollBar::add-line:horizontal,QScrollBar::sub-line:horizontal{width:0px;}
            QComboBox{background-color:#fff;color:#000;border:1px solid #ccc;border-radius:4px;padding:2px 8px;}
            QComboBox:hover{background-color:#f0f0f0;}
            QComboBox::drop-down{border:none;width:20px;}
            QComboBox QAbstractItemView{background-color:#fff;color:#000;selection-background-color:#2196F3;selection-color:white;}
            QLineEdit{background-color:#fff;color:#000;border:1px solid #ccc;border-radius:4px;padding:4px 8px;}
            QLineEdit:focus{border-color:#2196F3;}
            QMenu{background-color:#fff;color:#000;border:1px solid #ccc;}
            ...
            QGroupBox{color:#000;border:1px solid #ccc;border-radius:4px;margin-top:10px;padding-top:10px;}
            QGroupBox::title{subcontrol-origin:margin;left:10px;padding:0 5px 0 5px;}
        ...
        try:
            ...
            if cache_size_gb > 5.0:
                reply = QMessageBox.question(
                    self,
                    "缓存清理提醒",
                    f"缓存目录当前占用 {cache_size_gb:.2f} GB，超过 5 GB。是否自动清理？",
